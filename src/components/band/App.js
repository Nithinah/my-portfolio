...
useTexture.preload('/assets/PP_bw.png');
...
function Band({ isMobile, maxSpeed = 50, minSpeed = 10 }) {
  ...
  const profileTexture = useTexture('/assets/PP_bw.png');
  profileTexture.flipY = false;
  profileTexture.wrapS = THREE.MirroredRepeatWrapping;
  profileTexture.wrapT = THREE.MirroredRepeatWrapping;
  profileTexture.center.set(0.5, 0.5);
  profileTexture.offset.set(0.72, 0.17);
  profileTexture.repeat.set(-1.1, 1.2);
