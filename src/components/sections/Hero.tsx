...
const skills = ["Python", "TensorFlow", "PyTorch", "FastAPI", "RAG & LLMs", "Docker"];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <TextType
              text={["M.Sc. AI & ML @ CIT", "Voice AI & RAG Developer", "Agentic AI & Computer Vision"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
        ...
        >
          ...
          >
            Integrated M.Sc. candidate in Artificial Intelligence & Machine Learning at Coimbatore Institute of Technology. Experienced in building production Voice AI agents, explainable financial risk models, and multimodal RAG pipelines.
          </p>
        </motion.div>
